            ...
            <div className="bg-black border border-red-500/30 rounded-3xl p-10">
              ...
              <form className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  <input type="checkbox" id="privacy" required className="mt-1 accent-red-600" />
                  <label htmlFor="privacy" className="text-gray-400 text-sm">
                    I agree to the <a href="#" className="text-red-500 hover:text-red-400 font-medium">Privacy Policy</a> and consent to Digital Insights storing and processing my data.
                  </label>
                </div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <a href="tel:+97142415888" className="text-red-500 text-xl font-bold pl-7 hover:text-red-400 transition-colors">
                    +971 4 2415888
                  </a>
                  <p className="text-gray-400 text-sm pl-7 mt-1">24/7 Emergency Response</p>
                </div>
